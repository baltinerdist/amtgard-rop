...
Armor is period protective gear which grants an advantage to the wearer in combat by protecting them from physical blows. Armor can be based in history or fantasy.
...
1. Hits to armor in a hit location affect that hit location, regardless of if a physical piece of armor covers multiple hit locations. Example: Hitting the sleeve of a chainmail shirt will only affect that arm, and not the torso.
   a. Damage to worn armor is tracked by hit location. Damage will be retained if worn armor is altered, replaced, or exchanged.
...
Consists of unbacked small metal scales directly attached to one another by metal rings or similar methods. Scales must overlap by at least 10%. Scales are individually mobile.
